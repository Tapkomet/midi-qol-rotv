import { i18n, i18nFormat } from "../../midi-qol-rotv.js";
...
export class LateTargetingDialog extends Application {
	...
	static get defaultOptions() {
		...
		return foundry.utils.mergeObject(super.defaultOptions, {
			title: i18n("midi-qol-rotv.LateTargeting.Name"),
			classes: ["midi-targeting"],
			template: "modules/midi-qol-rotv/templates/lateTargeting.html",
			id: "midi-qol-rotv-lateTargeting",
			width: 300,
	...
	async getData(options = {}) {
		...
		if (this.data.item) {
			if (this.data.item.system.target.type === "creature" && this.data.item.system.target.value)
				...
				data.targetCount = "";
			data.blurb = i18nFormat("midi-qol-rotv.LateTargeting.Blurb", { targetCount: data.targetCount });
		}
		return data;
	}
